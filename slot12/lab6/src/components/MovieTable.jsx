...
const MovieTable = () => {
    ...
    const { movies, isFiltering, filteredMovies, genres, loading, movieToDelete, showDeleteModal } = state;
        ...
        <>
            {loading && movies.length === 0 ? (
                ...
                <Table striped bordered hover responsive className="mt-4">
                    ...
                    <tbody>
                        {(isFiltering ? filteredMovies : movies).length === 0 ? (
                            <tr>
                            ...
                            (isFiltering ? filteredMovies : movies).map((movie) => {
